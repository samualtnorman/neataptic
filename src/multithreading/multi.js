...
/** Workers */
export * as workers from "./workers/workers"
...
export function activateSerializedNetwork(input, A, S, data, F) {
...
export function deserializeDataSet(serializedSet) {
	var set = []
...
export function testSerializedSet(set, cost, A, S, data, F) {
